...
import { Mail, Lock, Eye, EyeOff, User, UserCheck, Brain } from 'lucide-react';
...
export const SignupPage: React.FC = () => {
    ...
    const { register, isAuthenticated, loginWithGoogle, loginWithGitHub } = React.useContext(AuthContext);
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showSuccess(
                ...
                `Welcome, ${response.data.firstName}! Your account has been created successfully.`
            );
        } catch (err) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Join MindStack</h1>
                    <p className="text-gray-600">Create your account and start tracking your coding journey</p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
                    <form onSubmit={handleSignup} className="space-y-6">
                        ...
                        <button
                            ...
                            className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3 px-4 rounded-xl font-semibold hover:border-purple-300 hover:text-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-all duration-200"
                        >
                            Sign In Instead
                        </button>
                    </form>
